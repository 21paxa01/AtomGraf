...
public class death_info : MonoBehaviour
{
    ...
    public string[] kolobok_titles, izba_titles, yaga_titles, vodyanoi_titles, ciklop_titles, oborot_titles, koshzei_titles;
    public string[] kolobok_info, izba_info, yaga_info, vodyanoi_info, ciklop_info, oborot_info, koshzei_info;
    public int test;
